...
public class AudioManager : MonoBehaviour
{
    ...
    public AudioSource PlayEffectClipAtPoint(AudioClip clip, Vector3 position, float volume, float duration)
    {
    ...
    public AudioSource PlayMusicClipAtPoint(AudioClip clip, Vector3 position, float volume = 1.0f)
    {
        var go = GetPooledObject();
        go.transform.position = position;
